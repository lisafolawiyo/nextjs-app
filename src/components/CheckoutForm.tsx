...
export default function CheckoutForm() {
  ...
  return (
    <div className="checkout-page">
      ...
      <form className="body-section" onSubmit={handleSubmit(onSubmit)}>
          ...
          <div className="form-wrapper">
            <div className="duo-input-wrap">
              ...
              <div className="duo-item">
                ...
                <Input {...register('lastname')} type="text" className="" />
                {errors.lastname && (
            ...
            <div className="single-input-wrap">
              ...
              <Input {...register('address')} type="text" className="" />
              {errors.address && (
            ...
            <div className="duo-input-wrap">
              <div className="duo-item">
                ...
                <Input {...register('city')} type="text" className="" />
                {errors.city && (
              ...
              <div className="duo-item">
                ...
                <Input {...register('postcode')} type="text" className="" />
                {errors.postcode && (
            ...
            <div className="duo-input-wrap">
              <div className="duo-item">
                ...
                <Input {...register('state')} type="text" className="" />
                {errors.state && (
            ...
            <div className="duo-input-wrap">
              ...
              <div className="duo-item">
                ...
                <Input {...register('phone')} type="text" className="" />
                {errors.phone && (
            ...
            <div className="flex items-center gap-3">
              <Checkbox id="terms" />
              <label htmlFor="terms">
                Please add me to the Lisafolawiyo email list
              </label>
            </div>
        ...
        <div className="order-summary-card">
          ...
          <div className="total-wrap">
            ...
            <div className="total-item total">
              <h3>Total</h3>
              {totalCart !== null && (
                <h3>${selectedShippingRate.fee + totalCart}</h3>
              )}
            </div>
          </div>
          ...
          {errors.root && (
            <div className="root-error text-red-500">{errors.root.message}</div>
          )}
        </div>
      </form>
    </div>
