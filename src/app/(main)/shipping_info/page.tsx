        ...
        <section className="page-section">
            <div className="page-section-inner">
                ...
                <div className="page-section-body about-section-body">
                  <p>
                    Shipping timelines are subject to the unique nature and craftsmanship of each piece. 
                  ...
                  <h1>Prices</h1>
                  <p>
                    Shipping costs will vary depending on the destination of your chosen items. 
                    Clothing prices displayed on the website are not inclusive of shipping or tax.
                  </p>
                  <h1>Customs & Import Duties</h1>
                  <p>
                    If an item ships to you from a different country, customs and import duties may be levied by your local government. 
