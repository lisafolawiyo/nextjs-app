  ...
  return (
    <>
      <div
        ...
        className="xl:border-t-1 xl:*:border-b-1 xl:*:border-[#212529] lg:*:border-r-1 [&>:first-child:border-l-1 grid  grid-cols-1 gap-0 max-md:gap-4 lg:grid-cols-3 xl:gap-0 xl:border-l-[1px] xl:border-black"
      >
